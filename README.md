...
To build the final jar and optimize the lmswiam application for production, run:
...
Then navigate to [http://localhost:8788](http://localhost:8788) in your browser.
