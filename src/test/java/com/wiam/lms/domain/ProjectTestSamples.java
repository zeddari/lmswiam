...
public class ProjectTestSamples {
    ...
    public static Project getProjectSample1() {
        return new Project().id(1L).titleAr("titleAr1").titleLat("titleLat1").videoLink("videoLink1");
    }

    public static Project getProjectSample2() {
        return new Project().id(2L).titleAr("titleAr2").titleLat("titleLat2").videoLink("videoLink2");
    }
