...
public class AyahsTestSamples {
    ...
    public static Ayahs getAyahsSample1() {
        return new Ayahs().id(1).number(1).numberInSurah(1).page(1).surahId(1).hizbId(1).juzId(1);
    }

    public static Ayahs getAyahsSample2() {
        return new Ayahs().id(2).number(2).numberInSurah(2).page(2).surahId(2).hizbId(2).juzId(2);
    }
