...
public class SiteTestSamples {
    ...
    public static Site getSiteSample1() {
        return new Site().id(1L).nameAr("nameAr1").nameLat("nameLat1").localisation("localisation1");
    }

    public static Site getSiteSample2() {
        return new Site().id(2L).nameAr("nameAr2").nameLat("nameLat2").localisation("localisation2");
    }
