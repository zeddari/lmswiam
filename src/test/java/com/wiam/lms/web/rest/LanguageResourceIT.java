...
class LanguageResourceIT {
    ...
    public static Language createEntity(EntityManager em) {
        Language language = new Language().nameAr(DEFAULT_NAME_AR).nameLat(DEFAULT_NAME_LAT).code(DEFAULT_CODE);
        return language;
    }
    ...
    public static Language createUpdatedEntity(EntityManager em) {
        Language language = new Language().nameAr(UPDATED_NAME_AR).nameLat(UPDATED_NAME_LAT).code(UPDATED_CODE);
        return language;
    }
    ...
    void createLanguage() throws Exception {
        ...
        assertThat(testLanguage.getNameAr()).isEqualTo(DEFAULT_NAME_AR);
        assertThat(testLanguage.getNameLat()).isEqualTo(DEFAULT_NAME_LAT);
    ...
    void putExistingLanguage() throws Exception {
        ...
        updatedLanguage.nameAr(UPDATED_NAME_AR).nameLat(UPDATED_NAME_LAT).code(UPDATED_CODE);
        ...
        Language testLanguage = languageList.get(languageList.size() - 1);
        assertThat(testLanguage.getNameAr()).isEqualTo(UPDATED_NAME_AR);
        assertThat(testLanguage.getNameLat()).isEqualTo(UPDATED_NAME_LAT);
        ...
        await()
            ...
            .untilAsserted(() -> {
                ...
                assertThat(testLanguageSearch.getNameAr()).isEqualTo(UPDATED_NAME_AR);
                assertThat(testLanguageSearch.getNameLat()).isEqualTo(UPDATED_NAME_LAT);
                assertThat(testLanguageSearch.getCode()).isEqualTo(UPDATED_CODE);
            });
    }
    ...
    void partialUpdateLanguageWithPatch() throws Exception {
        ...
        partialUpdatedLanguage.nameAr(UPDATED_NAME_AR);
    ...
    void fullUpdateLanguageWithPatch() throws Exception {
        ...
        partialUpdatedLanguage.nameAr(UPDATED_NAME_AR).nameLat(UPDATED_NAME_LAT).code(UPDATED_CODE);
