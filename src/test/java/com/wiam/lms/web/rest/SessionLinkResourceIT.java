...
class SessionLinkResourceIT {
    ...
    private static final SessionProvider DEFAULT_PROVIDER = SessionProvider.ZOOM;
    private static final SessionProvider UPDATED_PROVIDER = SessionProvider.TEAMS;
    ...
    void createSessionLink() throws Exception {
        ...
        assertThat(testSessionLink.getProvider()).isEqualTo(DEFAULT_PROVIDER);
    ...
    void putExistingSessionLink() throws Exception {
        ...
        updatedSessionLink.provider(UPDATED_PROVIDER).title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).link(UPDATED_LINK);
        ...
        SessionLink testSessionLink = sessionLinkList.get(sessionLinkList.size() - 1);
        assertThat(testSessionLink.getProvider()).isEqualTo(UPDATED_PROVIDER);
        ...
        await()
            ...
            .untilAsserted(() -> {
                ...
                assertThat(testSessionLinkSearch.getProvider()).isEqualTo(UPDATED_PROVIDER);
    ...
    void partialUpdateSessionLinkWithPatch() throws Exception {
        ...
        partialUpdatedSessionLink.provider(UPDATED_PROVIDER).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateSessionLinkWithPatch() throws Exception {
        ...
        partialUpdatedSessionLink.provider(UPDATED_PROVIDER).title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).link(UPDATED_LINK);
