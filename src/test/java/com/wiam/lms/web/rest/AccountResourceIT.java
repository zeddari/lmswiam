...
class AccountResourceIT {
    ...
    void testRegisterInvalidLogin() throws Exception {
        ...
        Optional<UserCustom> user = userRepository.findOneByEmailIgnoreCase("funky@example.com");
    ...
    void testRegisterInvalidEmail() throws Exception {
        ...
        Optional<UserCustom> user = userRepository.findOneByLogin("bob");
        assertThat(user).isEmpty();
    }
    ...
    void testRegisterDuplicateLogin() throws Exception {
        ...
        Optional<UserCustom> testUser = userRepository.findOneByEmailIgnoreCase("alice2@example.com");
    ...
    void testRegisterDuplicateEmail() throws Exception {
        ...
        Optional<UserCustom> testUser1 = userRepository.findOneByLogin("test-register-duplicate-email");
        ...
        Optional<UserCustom> testUser2 = userRepository.findOneByLogin("test-register-duplicate-email");
        assertThat(testUser2).isEmpty();

        Optional<UserCustom> testUser3 = userRepository.findOneByLogin("test-register-duplicate-email-2");
        ...
        Optional<UserCustom> testUser4 = userRepository.findOneByLogin("test-register-duplicate-email-3");
    ...
    void testRegisterAdminIsIgnored() throws Exception {
        ...
        Optional<UserCustom> userDup = userRepository.findOneWithAuthoritiesByLogin("badguy");
    ...
    void testSaveAccount() throws Exception {
        ...
        UserCustom updatedUser = userRepository.findOneWithAuthoritiesByLogin(user.getLogin()).orElse(null);
    ...
    void testSaveExistingEmail() throws Exception {
        ...
        UserCustom anotherUser = new UserCustom();
        ...
        UserCustom updatedUser = userRepository.findOneByLogin("save-existing-email").orElse(null);
    ...
    void testSaveExistingEmailAndLogin() throws Exception {
        ...
        UserCustom updatedUser = userRepository.findOneByLogin("save-existing-email-and-login").orElse(null);
    ...
    void testChangePasswordWrongExistingPassword() throws Exception {
        ...
        UserCustom updatedUser = userRepository.findOneByLogin("change-password-wrong-existing-password").orElse(null);
    ...
    void testChangePassword() throws Exception {
        ...
        UserCustom updatedUser = userRepository.findOneByLogin("change-password").orElse(null);
    ...
    void testChangePasswordTooSmall() throws Exception {
        ...
        UserCustom updatedUser = userRepository.findOneByLogin("change-password-too-small").orElse(null);
        assertThat(updatedUser.getPassword()).isEqualTo(user.getPassword());
    }
    ...
    void testChangePasswordTooLong() throws Exception {
        ...
        UserCustom updatedUser = userRepository.findOneByLogin("change-password-too-long").orElse(null);
        assertThat(updatedUser.getPassword()).isEqualTo(user.getPassword());
    }
    ...
    void testChangePasswordEmpty() throws Exception {
        ...
        UserCustom updatedUser = userRepository.findOneByLogin("change-password-empty").orElse(null);
        assertThat(updatedUser.getPassword()).isEqualTo(user.getPassword());
    }
    ...
    void testFinishPasswordReset() throws Exception {
        ...
        UserCustom updatedUser = userRepository.findOneByLogin(user.getLogin()).orElse(null);
