...
public class PdfService {
     ...
     */
    public File generatePdf(PdfDetail details, PdfRequest pdfRequest) throws IOException, DocumentException {
     ...
     * @return
     */
    public Context getContext(PdfDetail details, String variableName) {
