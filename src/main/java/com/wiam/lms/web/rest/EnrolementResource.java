    ...
    public ResponseEntity<Enrolement> partialUpdateEnrolement(
        ...
        Optional<Enrolement> result = enrolementRepository
            ...
            .map(existingEnrolement -> {
                if (enrolement.getRef() != null) {
                    existingEnrolement.setRef(enrolement.getRef());
                }
                if (enrolement.getEnrolementType() != null) {
                    existingEnrolement.setEnrolementType(enrolement.getEnrolementType());
                }
