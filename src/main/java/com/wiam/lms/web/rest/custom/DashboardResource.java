...
public class DashboardResource {
    ...
    public ResponseEntity<ChartData> getAbsenceData()
        ...
        ChartData chartData = ChartData.builder().chartSeries(chartSeries).countItems(currentAbsence).deltaLastMonthPercent(deltaPercent).build();
