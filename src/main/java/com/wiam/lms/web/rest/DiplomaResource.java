...
public class DiplomaResource {
    ...
    public ResponseEntity<Diploma> partialUpdateDiploma(
        ...
        Optional<Diploma> result = diplomaRepository
            ...
            .map(existingDiploma -> {
                if (diploma.getType() != null) {
                    existingDiploma.setType(diploma.getType());
                }
                ...
                if (diploma.getAttachment() != null) {
                    existingDiploma.setAttachment(diploma.getAttachment());
                }
                if (diploma.getAttachmentContentType() != null) {
                    existingDiploma.setAttachmentContentType(diploma.getAttachmentContentType());
                }
