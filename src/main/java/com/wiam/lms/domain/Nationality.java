...
@org.springframework.data.elasticsearch.annotations.Document(indexName = "nationality", createIndex = false)
...
public class Nationality implements Serializable {
    ...
    public Nationality nameAr(String nameAr) {
    ...
    public Nationality nameLat(String nameLat) {
    ...
    public void setUserCustoms(Set<UserCustom> userCustoms) {
        if (this.userCustoms != null) {
            this.userCustoms.forEach(i -> i.setNationality(null));
        }
        if (userCustoms != null) {
            userCustoms.forEach(i -> i.setNationality(this));
        }
        this.userCustoms = userCustoms;
    }

    public Nationality userCustoms(Set<UserCustom> userCustoms) {
        this.setUserCustoms(userCustoms);
        return this;
    }

    public Nationality addUserCustom(UserCustom userCustom) {
        this.userCustoms.add(userCustom);
        userCustom.setNationality(this);
        return this;
    }

    public Nationality removeUserCustom(UserCustom userCustom) {
        this.userCustoms.remove(userCustom);
        userCustom.setNationality(null);
        return this;
    }
